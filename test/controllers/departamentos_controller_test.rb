...
class DepartamentosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create departamento" do
    assert_difference("Departamento.count") do
      post departamentos_url, params: { departamento: { nome_depto: @departamento.nome_depto, orcamento: @departamento.orcamento, predio_id: @departamento.predio_id } }
    end
  ...
  test "should update departamento" do
    patch departamento_url(@departamento), params: { departamento: { nome_depto: @departamento.nome_depto, orcamento: @departamento.orcamento, predio_id: @departamento.predio_id } }
