...
class SalasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sala" do
    assert_difference("Sala.count") do
      post salas_url, params: { sala: { capacidade: @sala.capacidade, num_sala: @sala.num_sala, predio_id: @sala.predio_id } }
    end
  ...
  test "should update sala" do
    patch sala_url(@sala), params: { sala: { capacidade: @sala.capacidade, num_sala: @sala.num_sala, predio_id: @sala.predio_id } }
