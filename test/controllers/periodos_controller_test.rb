...
class PeriodosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create periodo" do
    assert_difference("Periodo.count") do
      post periodos_url, params: { periodo: { data: @periodo.data, hora_final: @periodo.hora_final, hora_inicial: @periodo.hora_inicial } }
    end
  ...
  test "should update periodo" do
    patch periodo_url(@periodo), params: { periodo: { data: @periodo.data, hora_final: @periodo.hora_final, hora_inicial: @periodo.hora_inicial } }
