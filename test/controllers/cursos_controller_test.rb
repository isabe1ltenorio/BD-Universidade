...
class CursosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create curso" do
    assert_difference("Curso.count") do
      post cursos_url, params: { curso: { creditos: @curso.creditos, departamento_id: @curso.departamento_id, nome_curso: @curso.nome_curso } }
    end
  ...
  test "should update curso" do
    patch curso_url(@curso), params: { curso: { creditos: @curso.creditos, departamento_id: @curso.departamento_id, nome_curso: @curso.nome_curso } }
